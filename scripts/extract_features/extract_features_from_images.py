...
for frame_index in np.arange(1,len(img_loader_obj.frame_indices)+1):
    ...
    # Use Radon transform on the canny edge map with sigma = 6 (to detect aponeuroses)
    sigma = 6.5
...
np.savetxt('../../results/pennation_angle.csv', penn, delimiter=',')
np.savetxt('../../results/theta_1.csv', th1, delimiter=',')
np.savetxt('../../results/theta_2.csv', th2, delimiter=',')
np.savetxt('../../results/pos_deep.csv', deep, delimiter=',')
np.savetxt('../../results/pos_fas.csv', pos_fascicle, delimiter=',')
